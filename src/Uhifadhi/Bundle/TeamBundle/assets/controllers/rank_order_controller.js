 ...
 *
 * The ranks ladder moves by the shell's reorder control now,
 ...
 * `assets/controllers.json` may still enable `rank-order`, and StimulusBundle
 * refuses to render a page whose enabled controller has no file. Remove that
 * entry (see UPGRADE-1.0.md, "Rows move by the shell's reorder control").
 */
