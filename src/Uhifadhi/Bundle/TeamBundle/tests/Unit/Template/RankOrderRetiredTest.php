...
/**
 * THE RANKS LADDER MOVES BY THE SHELL'S REORDER CONTROL, AND NO Team TEMPLATE NAMES
 ...
 * keys, and announces the move; Team › Configure › Ranks wears it.
 *
 ...
 */
final class RankOrderRetiredTest extends TestCase
{
    private const string RETIRED = 'uhifadhi--team-bundle--rank-order';
    ...
    {
        $file = \dirname(__DIR__, 3).'/assets/controllers/rank_order_controller.js';
    ...
    {
        foreach ([
            \dirname(__DIR__, 3).'/assets/package.json' => 'controllers/rank_order_controller.js',
            \dirname(__DIR__, 7).'/assets/package.json' => '../src/Uhifadhi/Bundle/TeamBundle/assets/controllers/rank_order_controller.js',
        ] as $manifest => $main) {
            ...
            $entry = $package['symfony']['controllers']['rank-order'] ?? null;

            self::assertIsArray($entry, $manifest.' still declares rank-order');
